    ...
    */
                       ...
                       const W & default_w, Results & results, int advance) const
    {
        ...
        */
        ...
        float ZNew = results.add(feature, w, 0.5, missing);
        results.finish(feature);
                        ...
                        int advance) const
    {
        ...
        if (!results.start(feature, w, missing)) return Z::worst;
        float ZNew = results.add_presence(feature, w, 0.5, missing);
        results.finish(feature);
                           ...
                           int advance) const
    {
        ...
        */
        ...
        if (i != 0) {
            ZNew = results.add(feature, w, -INFINITY, missing);
        
            if (debug)
                cerr << "added split " << -INFINITY << " with " << missing
                     << " missing and score " << ZNew << endl;
        }
                       ...
                       int advance) const
    {
        ...
        if (debug) {
            ...
            cerr << "added default split " << -INFINITY << " with "
                 << missing << " missing and score " << ZNew
                 << endl;
        }
